...
export default function TareasDocentePage() {
  ...
  return (
    <div className="py-6 w-full max-w-3xl">
      <h1 className="text-xl font-bold text-gray-800 mb-1">Tareas</h1>
      <p className="text-sm text-gray-500 mb-6">Selecciona un curso para revisar las entregas de tus alumnos.</p>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {cursos.map(c => (
            <Link key={c.curso_id ?? c.id} href={`/aula-virtual-docente/curso/${c.curso_id ?? c.id}?tab=tareas`}
